        ...
        <div className="rounded-2xl border border-softBorder bg-customCard/60 p-6">
          {success ? (
            <div className="py-10 text-center">
              <h3 className="text-2xl font-extrabold text-mainText">Thank you!</h3>
              ...
              <button
                ...
                className="mt-6 inline-flex items-center justify-center rounded-xl border border-softBorder bg-customCard/60 px-6 py-3 font-bold text-mainText backdrop-blur transition hover:bg-customCard/80 focus:outline-none focus:ring-2 focus:ring-primary/20"
              >
            ...
            <form className="grid gap-4" onSubmit={onSubmit} noValidate>
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Your name"
                  />
                  {showError("name") && <p className="mt-1 text-sm text-red-400">{errors.name}</p>}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="you@email.com"
                  />
                  {showError("email") && <p className="mt-1 text-sm text-red-400">{errors.email}</p>}
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Write your message..."
                />
                {showError("message") && <p className="mt-1 text-sm text-red-400">{errors.message}</p>}
              </div>
